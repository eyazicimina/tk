...
tile_types = [ "OpenStreetMap", "CartoDBpositron", "CartoDBdark_matter", "StamenTerrain", "StamenToner", "StamenWatercolor"]

for t in tile_types:
    #m = folium.Map([32.726834056040595, 39.97360709568655], zoom_start=6, tiles=t)
    m = folium.Map([28.726834056040595, 44.97360709568655], zoom_start=5, tiles=t)
